		...
		<div class="panel-body">
			...
			<label>Images1</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image1"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage1</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg1"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images4</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image4"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage4</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg4"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images7</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image7"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage7</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg7"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images10</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image10"><img src="photo/select.png"></button></span>
				</div>
			</form>
		...
		<div class="panel-body">
			...
			<label>Images2</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image2"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage2</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg2"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images5</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image5"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage5</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg5"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images8</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image8"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage8</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg8"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>ImageMessage10</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg10"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		...
		<div class="panel-body">
			...
			<label>Images3</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image3"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage3</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg3"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images6</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image6"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage6</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg6"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Images9</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="image9"><img src="photo/select.png"></button></span>
				</div>
			</form>
			<form action="managegallery.php" method="POST" role="form" enctype="multipart/form-data">
			<label>ImageMessage9</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="msg9"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
		<div class="panel-body">
			...
			<label>Album Name</label>
				<div class="form-group input-group">
					...
					<span class="input-group-addon"><button type="submit" name="album1"><img src="photo/select.png"></button></span>
				</div>
			</form>
		</div>
	</div>
...
<br/>
									...
									<label>Album Name</label>
										<div class="form-group input-group">
                                            ...
                                            <input type="text" value="<?php echo $album; ?>" class="form-control" placeholder="Album Name" name="album"/>
										</div>
